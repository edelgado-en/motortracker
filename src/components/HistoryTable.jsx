              ...
              { carStats.length > 0 ?
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {carStats.map((stat) => (
                            <tr key={stat.id}>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{stat.timeStamp}</td>
                ...
                :
                <div style={{ margin: 'auto', width: '80%', textAlign: 'center', marginTop: '150px' }}>No data collected</div>    
            }
