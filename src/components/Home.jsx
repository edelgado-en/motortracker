            ...
            { cars.length > 0 ?
                <>
                    <div style={{ marginBottom: '20px', textAlign: 'right' }}>
                        <Dropdown 
                            cars={cars}
                            handleSelectedCar={findCarStats}
                        />
                    </div>
                    <HistoryTable 
                        carStats={carStats}
                ...
                :
                !loading ?
                    <div style={{ margin: 'auto', width: '80%', textAlign: 'center', marginTop: '250px' }}>
                        No registered cars found. Go to the Register Car tab to register a car.
                    </div>
